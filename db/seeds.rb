...
user1 = User.create!(
  ...
  password: "123456",
  user_photo: "https://res.cloudinary.com/wagon/image/upload/c_fill,g_face,h_200,w_200/qqtccckpyj555oibt676.jpg")
user2 = User.create!(
  full_name: "Felipe De Alba",
  email: "felipe@lewagon.com",
  password: "123456",
  user_photo: "https://avatars3.githubusercontent.com/u/54073875?v=4")
user3 = User.create!(
  full_name: "Bitna Kim",
  email: "bitna@lewagon.com",
  password: "123456",
  user_photo: "https://res.cloudinary.com/wagon/image/upload/c_fill,g_face,h_200,w_200/zizjr3r1g3d2b1vlp1iy.jpg")
user4 = User.create!(
  full_name: "Fanny Rojon",
  email: "fanny@lewagon.com",
  password: "123456",
  user_photo: "https://avatars2.githubusercontent.com/u/54022229?v=4")
